...
<div class="lx-shell">
  ...
  <section id="jump" class="lx-section">
    <div class="lx-links">
      <a class="lx-link" href="/registry/"><strong>Listing registry</strong><span>The PR format and verification pipeline.</span></a>
      <a class="lx-link" href="/registry/verification"><strong>Signatures</strong><span>Ed25519 verification against the official key.</span></a>
      <a class="lx-link" href="/guide/how-it-works"><strong>/sell endpoint</strong><span>What sellers publish and how it's checked.</span></a>
  ...
  <div class="lx-shell">
    <div class="lx-footer-grid">
      ...
      <nav class="lx-fcol" aria-label="Protocol">
        <h4>Protocol</h4>
        <ul>
          <li><a href="/registry/">Listing registry</a></li>
          <li><a href="/guide/quick-start">Manifest schema</a></li>
          <li><a href="/registry/verification">Signatures</a></li>
          <li><a href="/guide/how-it-works">/sell endpoint</a></li>
        </ul>
      </nav>
