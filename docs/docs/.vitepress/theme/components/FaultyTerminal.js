/**
 * FaultyTerminal — OGL port of ReactBits' FaultyTerminal component.
 * Uses the official OGL library for WebGL, matching the original React source.
 */
...
export default function createFaultyTerminal(container, options = {}) {
  const {
    scale = 1,
    gridMul = [2, 1],
    digitSize = 1.5,
